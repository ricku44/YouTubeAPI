...
/**
 * Created by Shashank on 17-02-2018.
 */

public class MoviesAdaptor extends RecyclerView.Adapter<MoviesAdaptor.YoutubePostHolder> {
    ...
    MoviesAdaptor(Context mContext, ArrayList<YoutubeDataModel> dataSet, OnItemClickListener listener) {
